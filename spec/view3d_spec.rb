...
describe View3D do
  ...
  describe '#is_a_view3d?' do
    ...
    context 'for jt files' do
      let(:entry) { 'DOCUMENTS/162548716-915004122901/915004122901-DEVELOPMNT-3DVIEW.088505.JT' }
      it { should be_true }
    end
    context 'for stp files' do
      let(:entry) { 'DOCUMENTS/162548716-915004122901/915004122901-DEVELOPMNT-3DVIEW.088505.StP' }
      it { should be_true }
    end
  ...
  describe '.filename' do
    ...
    it{ should eql Pathname.new('16254').join('16254-3DVIEW.EXT')}
  end
end
